...
<head>
    ...
    <title>SIPAKADUS - Penduduk Lansia</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data Penduduk Lansia</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
						...
						?>
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Penduduk</span> Lansia</h1>
                                </div>
                            </div>
			            	...
			            	foreach($sql as $data){ 
			            		?>
									...
									<td><a href='?mod=edit&id=<?php echo $data['nik'];?>'>
										...
										<a href='aksi2.php?mod=delete&nik=<?php echo $data['nik'];?>' onClick="return confirm('Yakin akan menghapus Data?')">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Tambah Data Penduduk Lansia</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi2.php?mod=tambah' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <a href="data_penduduk_lansia.php" class="btn btn-danger">Kembali</a>
																</div>
                                                            </div>
                                                        </div>
                                                    </form>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ubah Data Penduduk Lansia</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi2.php?mod=edit' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
