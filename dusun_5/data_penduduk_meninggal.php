...
<head>
    ...
    <title>SIPAKADUS - Penduduk</title>
    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data Penduduk Meninggal</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						?>
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Penduduk</span> Meninggal</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="meninggal" data-editable="true">Meninggal</th>
						...
						<?php 
			            		$no = 0;
			            		$sql = $db->query("SELECT * FROM kematian where dusun = 'Tgk. Tanoh Abee'");
			            	foreach($sql as $data){ 
			            		?>
									<tr>
									<td></td>
									...
									<td><?php echo date('d-m-Y',strtotime($data['meninggal']));?>  </td>
									...
									<td><a href='?mod=edit&id=<?php echo $data['nik'];?>'>
										...
										<a href='aksi7.php?mod=delete&nik=<?php echo $data['nik'];?>' onClick="return confirm('Yakin akan menghapus Data?')">
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Tambah Data Penduduk Meninggal</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi7.php?mod=tambah' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<label>Tanggal Meninggal</label>
                                                                    <input name="tgl_meninggal" id="tgl_meninggal" type="date" class="form-control" placeholder="Tanggal Meninggal" required>
                                                                </div>
                                                               <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <a href="data_penduduk_meninggal.php" class="btn btn-danger">Kembali</a>
																</div>
                                                            </div>
                                                        </div>
                                                    </form>
				...
				case 'edit':
					$sql = $db->query("SELECT * FROM kematian WHERE nik ='$_GET[id]' ");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ubah Data Penduduk Meninggal</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi7.php?mod=edit' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
																<label>Tanggal Meninggal</label>
                                                                     <input name="tgl_meninggal" id="tgl_meninggal" type="date" class="form-control" placeholder="Tanggal Meninggal" value='<?php echo $data['meninggal'];?>' required>
                                                                </div>
																<div class="form-group">
                                                                    <select name="status_kel" id="status_kel"  class="form-control" required>
																			<option value="#" selected="" disabled="">Status keluarga</option>
																			<option value="Kepala Keluarga" <?php if ($data['status_keluarga']=='Kepala Keluarga'){echo"SELECTED";}?>>Kepala Keluarga</option>
																			<option value="Istri"<?php if ($data['status_keluarga']=='Istri'){echo"SELECTED";}?>>Istri</option>
																			<option value="Anak" <?php if ($data['status_keluarga']=='Anak'){echo"SELECTED";}?>>Anak</option>
																			<option value="Lainnya" <?php if ($data['status_keluarga']=='Lainnya'){echo"SELECTED";}?>>Lainnya</option>
																		</select>
                                                                </div>
                                                               </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
