...
include "koneksi.php";
session_start();
if($_SESSION['username']== '' OR $_SESSION['dusun']=='' OR $_SESSION['dusun'] !== 'Tgk. Tanoh Abee'){
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                ...
                                <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
								<?php 
								$sql = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Tetap' and dusun = 'Tgk. Tanoh Abee'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
								</span><span> Jiwa</span></h2>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                ...
                                <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
								<?php 
								$sql = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Tidak Tetap' and dusun = 'Tgk. Tanoh Abee'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
								</span><span> Jiwa</span></h2>
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="analytics-sparkle-line reso-mg-b-30">
                        <div class="analytics-content">
                            ...
                            <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
							<?php 
								$sql = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Lansia' and dusun = 'Tgk. Tanoh Abee'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
							</span><span> Jiwa</span></h2>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="analytics-sparkle-line reso-mg-b-30">
								...
								<?php 
								$sql = $db->query("SELECT * FROM usaha where dusun = 'Tgk. Tanoh Abee'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
