	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			<div class="text-center m-b-md custom-login">
				<h3>LOGIN SIPAKADUS KOTA BARU</h3>
			</div>
           ...
           <?php include('errors.php'); ?>
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="NIK" title="Please enter you NIK" name="username" id="username" class="form-control" required>
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
							 <label class="control-label" for="dusun">Nama Dusun</label>
                            ...
                            <button class="btn btn-success btn-block loginbtn" type="submit" name="login_user" id="login_user">Login</button>
                        </form>
                    </div>
                </div>
			</div>
