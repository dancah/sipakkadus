...
include "koneksi.php";
session_start();
if($_SESSION['username']== '' OR $_SESSION['dusun']=='' OR $_SESSION['dusun'] !== 'Tgk. Malikul Saleh'){
...
<head>
    ...
    <title>SIPAKADUS - Dashboard</title>
    ...
    <div class="all-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>WAKTU</h5>
                                <h2><img src="img/kalender.png" width="52.2px" style="margin:8px;" alt=""/><?php echo date("d-m-Y");?></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="analytics-sparkle-line reso-mg-b-30">
                        <div class="analytics-content">
							<h5>Jumlah User</h5>
                            <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
							<?php 
								$sql = $db->query("SELECT * FROM user where dusun = 'Tgk. Malikul Saleh'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
							</span><span> Pengguna</span></h2>
                        </div>
                    </div>
					</div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Jumlah Semua Penduduk</h5>
                                <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
								<?php 
								$sql = $db->query("SELECT * FROM penduduk where dusun = 'Tgk. Malikul Saleh'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
								</span><span> Jiwa</span></h2>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Jumlah Penduduk Tetap</h5>
                                <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
								<?php 
								$sql = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Tetap' and dusun = 'Tgk. Malikul Saleh'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
								</span><span> Jiwa</span></h2>
		...
		<div class="product-sales-area mg-tb-30">
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Jumlah Penduduk Tidak Tetap</h5>
                                <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
								<?php 
								$sql = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Tidak Tetap' and dusun = 'Tgk. Malikul Saleh'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
								</span><span> Jiwa</span></h2>
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="analytics-sparkle-line reso-mg-b-30">
                        <div class="analytics-content">
							<h5>Jumlah Penduduk Lansia</h5>
                            <h2><img src="img/avatar.png" width="60px" style="margin:8px;" alt=""/><span class="counter">
							<?php 
								$sql = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Lansia' and dusun = 'Tgk. Malikul Saleh'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
							</span><span> Jiwa</span></h2>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="analytics-sparkle-line reso-mg-b-30">
								<div class="analytics-content">
                                <h5>Jumlah Tempat Usaha</h5>
                                <h2><img src="img/usaha.png" width="75px" style="margin:8px;" alt=""/><span class="counter">
								<?php 
								$sql = $db->query("SELECT * FROM usaha where dusun = 'Tgk. Malikul Saleh'");
								$jumlah=mysqli_num_rows($sql);
								echo $jumlah;
								?>
								</span><span> Tempat</span></h2>
								</div>
							</div>
						</div>
					</div>
