                ...
                <div class="container-fluid">
                    <div class="row">
						...
						<div class="row">
                            <div class="col-lg-12">
                                <div class="payment-adress">
								    <a href="rekap_data_total.php" class="btn btn-primary">Rekap Data Total Penduduk</a>
								</div>
                            </div>
                        </div> <br> </br>
						<div class="row">
                            <div class="col-lg-12">
                                <div class="payment-adress">
									<a href="rekap_data_dusun1.php" class="btn btn-primary">Rekap Data Penduduk Tgk. Dibitai</a>
								</div>
                            </div>
                        </div> <br> </br>
						<div class="row">
                            <div class="col-lg-12">
                                <div class="payment-adress">
									<a href="rekap_data_dusun3.php" class="btn btn-primary">Rekap Data Penduduk Tgk. Lam U</a>
								</div>
                            </div>
                        </div> <br> </br>
						<div class="row">
                            <div class="col-lg-12">
                                <div class="payment-adress">
									<a href="rekap_data_dusun2.php" class="btn btn-primary">Rekap Data Penduduk Tgk. Cot Plieng</a>
								</div>
                            </div>
                        </div> <br> </br>
						<div class="row">
                            <div class="col-lg-12">
                                <div class="payment-adress">
									<a href="rekap_data_dusun5.php" class="btn btn-primary">Rekap Data Penduduk Tgk. Tanoh Abee</a>
								</div>
                            </div>
                        </div><br> </br>
						...
						<div class="row">
                            <div class="col-lg-12">
                                <div class="payment-adress">
									<a href="rekap_data_dusun4.php" class="btn btn-primary">Rekap Data Penduduk Tgk. Malikul Saleh</a>
								</div>
                            </div>
                        </div>
