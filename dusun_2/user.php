...
session_start();
session_start();
if($_SESSION['username']== '' AND $_SESSION['dusun']=='' AND $_SESSION['dusun']!=='Tgk. Cot Plieng'){
    ...
    <div class="all-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						?>
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n"></span>User</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="desa" data-editable="true">Gampong</th>
						...
						<?php 
			            		$no = 0;
			            		$sql = $db->query("SELECT * FROM user where dusun='Tgk. Cot Plieng'");
			            	foreach($sql as $data){ 
			            		?>
									<tr>
									<td></td>
									...
									<td><a href='?mod=edit&id=<?php echo $data['nik'];?>'>
										...
										<a href='aksi6.php?mod=delete&id=<?php echo $data['nik'];?>' onClick="return confirm('Yakin akan menghapus Data?')">
										...
										<a href="?mod=reset&id=<?php echo $data['nik'];?>" class="btn btn-warning">Reset Password</a>
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Tambah Data User</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi6.php?mod=tambah' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
															...
															<div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="gampong" id="gampong" type="text" class="form-control" placeholder="Gampong" value="Kota Baru" readonly required>
                                                                </div>
				...
				case 'edit':
					$sql = $db->query("SELECT * FROM user WHERE nik ='$_GET[id]' ");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ubah Data User</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi6.php?mod=edit' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<div class="form-group">
                                                                    <input name="nama" id="nama" type="text" class="form-control" placeholder="Nama Lengkap" value='<?php echo $data['nama'];?>' required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="gampong" id="gampong" type="text" class="form-control" placeholder="Gampong" value='<?php echo $data['gampong'];?>' required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <select name="dusun" id="dusun"  class="form-control" required>
																...
																<div class="form-group">
                                                                    <input name="password" id="password" type="password" class="form-control" placeholder="Password" value='<?php echo $data['password'];?>' required>
                                                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ubah Password</a></li>
                                ...
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi6.php?mod=reset' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															<div class="form-group">
																	<input name="nik" id="nik" type="hidden" class="form-control" value='<?php echo $data['nik'];?>'>
                                                                    <input name="password1" id="password1" type="text" class="form-control" placeholder="Password Baru" required>
                                                             </div>
													   </div>
														</div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
																<button type="submit" name="submit" class="btn btn-primary waves-effect waves-light" onClick="return confirm ('Yakin akan Merubah Password?')">Submit</button>
                                                                <a href="user.php" class="btn btn-danger">Kembali</a>
																</div>
                                                            </div>
                                                        </div>
