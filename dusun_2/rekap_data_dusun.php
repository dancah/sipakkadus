                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Rekap Data Penduduk Tgk. Cot Plieng</a></li>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<label>DUSUN / JURONG</label>
                                                                       <input name="dusun" id="dusun" type="text" class="form-control" value="Tgk. Cot Plieng" readonly required>
                                                              	</div>
																<div class="form-group">
																...
																<label>JENIS TEMPAT USAHA</label>
																		<table>
																			...
																			include "koneksi.php";
																					$no = 0;
																					$sql = $db->query("SELECT distinct(jenis_usaha) FROM usaha where dusun='Tgk. Cot Plieng'");
