    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data Penduduk Pindah</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						?>
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Data <span class="table-project-n">Penduduk</span> Pindah</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="pindah" data-editable="true">Pindah</th>
						...
						<?php 
			            		$no = 0;
			            		$sql = $db->query("SELECT * FROM pindah where dusun = 'Tgk. Cot Plieng'");
			            	foreach($sql as $data){ 
			            		?>
									<tr>
									<td></td>
									...
									<td><?php echo date('d-m-Y',strtotime($data['pindah']));?>  </td>
									...
									<td><a href='?mod=edit&id=<?php echo $data['nik'];?>'>
										...
										<a href='aksi8.php?mod=delete&nik=<?php echo $data['nik'];?>' onClick="return confirm('Yakin akan menghapus Data?')">
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Tambah Data Penduduk Pindah</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi8.php?mod=tambah' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<label>Tanggal Pindah</label>
                                                                    <input name="tgl_pindah" id="tgl_pindah" type="date" class="form-control" placeholder="Tanggal Pindah" required>
                                                                </div>
                                                               <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <a href="data_penduduk_pindah.php" class="btn btn-danger">Kembali</a>
																</div>
                                                            </div>
                                                        </div>
                                                    </form>
				...
				case 'edit':
					$sql = $db->query("SELECT * FROM pindah WHERE nik ='$_GET[id]' ");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ubah Data Penduduk Pindah</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='aksi8.php?mod=edit' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
																<label>Tanggal Pindah</label>
                                                                     <input name="tgl_pindah" id="tgl_pindah" type="date" class="form-control" placeholder="Tanggal Pindah" value='<?php echo $data['pindah'];?>' required>
                                                                </div>
																<div class="form-group">
                                                                    <select name="status_kel" id="status_kel"  class="form-control" required>
																			<option value="#" selected="" disabled="">Status keluarga</option>
