    ...
    <div class="all-content-wrapper">
		...
		<?php
			...
			include "koneksi.php";
					...
					$sql1 = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Tetap'");
					$jumlah=mysqli_num_rows($sql);
					
					$sql2 = $db->query("SELECT * FROM penduduk where status_kel = 'Kepala Keluarga'");
					$jumlah2=mysqli_num_rows($sql2);
					
					$sql3 = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Penduduk Tidak Tetap'");
					$jumlah3=mysqli_num_rows($sql3);
					
					$sql4 = $db->query("SELECT * FROM penduduk where jenis_kependudukan = 'Lansia'");
					$jumlah4=mysqli_num_rows($sql4);
					
					$sql5 = $db->query("SELECT * FROM usaha");
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Rekap Data Total Penduduk</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method='POST' action='rekaptotalpdf.php' class="dropzone dropzone-custom needsclick add-professors">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
																<label>JUMLAH DUSUN / JURONG</label>
                                                                    <input name="dusun" id="dusun" type="text" class="form-control" value="5" readonly required>
                                                                </div>
                                                                <div class="form-group">
																<label>GAMPONG</label>
																...
																<label>JUMLAH PENDUDUK TETAP</label>
                                                                    <input name="penduduk_tetap" id="penduduk_tetap" type="text" class="form-control" value="<?php echo $jumlah;?>" readonly required>
                                                                </div>
																<div class="form-group">
																...
																<label>JUMLAH PENDUDUK TIDAK TETAP</label>
                                                                    <input name="penduduk_tidaktetap" id="penduduk_tidaktetap" type="text" class="form-control" value="<?php echo $jumlah3;?>" readonly required>
                                                                </div>
																<div class="form-group">
																...
																<label>JENIS TEMPAT USAHA</label>
																		<table>
																			...
																			include "koneksi.php";
																					$no = 0;
																					$sql = $db->query("SELECT distinct(jenis_usaha) FROM usaha");
																					$jumlah=mysqli_num_rows($sql);
